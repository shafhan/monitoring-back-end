...
function segitiga(int $sisiA, int $sisiB, int $sisiC, int $alas, int $tinggi) {
...
function trapesium(int $sisiA, int $sisiB, int  $sisiC,int $sisiD, int $alas, int $tinggi)  {
    /*
    alas = sisiA
