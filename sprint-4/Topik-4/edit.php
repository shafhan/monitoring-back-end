...
$id = $_GET['id'];
$result = $call->showAll("SELECT * FROM content_page WHERE id = '$id'")[0];
if(isset($_POST['edit'])) {
    $call->update($_POST); 
...
<body>
    <div id="top">
        ...
        <div id="add-content-form">
                ...
                <div id="form">
                    <form action="" method="post" enctype="multipart/form-data">
                        <ul>
                            ...
                            <li>
                                <input class="input" type="input" name="judul" placeholder="Title..." value="<?= $result['judul'] ?>" required>
                            </li>
                            <li>
                                <textarea class="input" id="textarea" name="content..." placeholder="Content..."><?= $result['content'] ?></textarea>
                            </li>
                            <li>
                                <input class="input" type="input" name="kategori"  placeholder="Category..." value="<?= $result['category'] ?>" required>
                            </li>
                            <li>
                                <button type="submit" name="edit"><span></span>Edit</button>
                            </li>
                        </ul>
                    </form>
                </div>
            ...
            <div id="right-side">
                <div id="gambar">
                    <img src="images/<?= $result['gambar'] ?>" width="100%">
                </div>
            </div>
        </div>
    </div>
